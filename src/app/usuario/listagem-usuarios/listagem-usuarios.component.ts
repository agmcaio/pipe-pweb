...
export class ListagemUsuariosComponent implements OnInit{
  ...
  constructor(private usuarioService: UsuarioService, private mensagemConsoleService: MensagemConsoleService) {
  }
    ...
    if (usuarioARemover.id) {
      this.usuarioService.apagar(usuarioARemover.id).subscribe(
        usuarioRemovido => {
          ...
          this.mensagemConsoleService.alert("Usuário removido");
        }
      );
    }
